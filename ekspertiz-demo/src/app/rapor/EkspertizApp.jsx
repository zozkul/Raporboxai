...
Yapı Ruhsatı ve Yapı Kullanma İzin Belgelerinde ada ve parsel formun üst kısmındaki tabloda ayrı hücrelerde yer alır. Alan etiketleri "3.Pafta No", "4.Ada No", "5.Parsel No" şeklinde numaralandırılmıştır — bu numaralar (3, 4, 5) ALAN NUMARASIDIR, ada/parsel değeri DEĞİLDİR. "ada" alanına SADECE "4.Ada No" etiketinin karşısındaki hücredeki sayıyı yaz. "parsel" alanına SADECE "5.Parsel No" etiketinin karşısındaki hücredeki sayıyı yaz. Örnek: etiket "5.Parsel No" olsa bile hücre içinde "8" yazıyorsa parsel="8" yazarsın, "5" değil. Pafta numarasını (F21C22B1A gibi harf+rakam kombinasyonu) ada veya parsel alanına YAZMA.
